...
import 'layout/minimal_section_header.dart';

/// Full-screen terms + consent UI (sprout green canvas) shared by onboarding
/// [StepTerms] and [LegalConsentScreen].
class TermsConsentLayout extends StatefulWidget {
...
class _TermsConsentLayoutState extends State<TermsConsentLayout> {
  bool _agreed = false;
  bool _saving = false;
