  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm text-center">
        ...
        />
        <h1 className="text-2xl font-extrabold text-forest-deep mb-2">Sign in on the app</h1>
        <p className="text-forest-deep/55 text-sm leading-relaxed mb-8">
          Web sign-in is not available yet. Download the {APP_NAME} app to access your account on iOS or Android.
        </p>
